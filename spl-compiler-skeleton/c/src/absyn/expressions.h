...
/**
 * This enum represents the possible operators for unary expressions in SPL.
 */
typedef enum {
    ABSYN_OP_UNARY_MINUS,
} UnaryOperator;
...
/**
 * @param operator An operator
 * @return Whether this operator is for equality (=, #)
 */
...
/**
 * Creates a new node representing an expression with an unary operator.
 * @param line The position of the expression in the source code.
 * @param op The operator used in this expression.
 * @param operand The operand on the left hand side of the operator.
 * @return A pointer to a newly created node.
 */
