...
static void enterPredefinedTypes(SymbolTable *table, CommandLineOptions *options) {
...
static void enterPredefinedProcs(SymbolTable *table, CommandLineOptions *options) {
    /* printi(i: int) */
...
SymbolTable *initializeGlobalTable(CommandLineOptions *options) {
    SymbolTable *table = newTable(NULL);

    enterPredefinedTypes(table, options);
    enterPredefinedProcs(table, options);
    return table;
}
