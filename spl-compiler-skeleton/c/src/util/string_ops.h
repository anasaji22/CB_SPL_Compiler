...
/**
 * Joins a list of strings with a separated inserted between every two elements.
...
/**
 * Comparator function for strings used for string sorting
 */
int str_comparator(void const *left, void const *right);
